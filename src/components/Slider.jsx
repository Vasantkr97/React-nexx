...
const Slider = ({ images }) => {
    const imagesArr = [...images, ...images]; // Duplicates the images array
    return (
        <div className="h-[200px] relative overflow-hidden mx-auto max-w-scrren-xl">
            ...
            after:h-full after:w-1/4 after:from-white after:to-transparent"></div>
                    ...
                    <div key={index} className="h-full flex-shrink-0">
                        <div className="flex items-center justify-center h-[200px]">
                            <img 
                                src={image.logo} 
                                alt={image.name} 
                                className="h-full max-w-full opacity-75
                                object-contain"
                            />
                        </div>
                    </div>
